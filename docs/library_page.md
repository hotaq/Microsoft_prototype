...
<button class="ml-auto px-4 py-1.5 bg-[#4a4e69] text-white text-[10px] font-bold uppercase tracking-widest rounded-full flex items-center gap-2 shadow-sm hover:opacity-90 transition-opacity">
